...
A copy of the master directory with complete materials can be downloaded here: [MerlinsManuscript.tar.gz [4.4GB]](https://drive.google.com//uc?export=download&confirm=w4JS&id=1w3rJhchSeyjtWiUCoUCXveMOkqpX6bZ5) <br/>
