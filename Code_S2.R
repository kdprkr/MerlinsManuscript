...
ofs_WS_all <- "MerlinsManuscript/supplement/File_S1.Rdata"
...
# anyway, the final workspace is saved here (twice), it may take a little while

ofs_WS_all <- "MerlinsManuscript/supplement/File_S1.Rdata.gzip"
save.image(file = ofs_WS_all)
